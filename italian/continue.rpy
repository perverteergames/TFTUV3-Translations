...
translate italian strings:
    ...
    new "Hai sabotato la fabbrica di mungitura umana su Barranthis?"

    # game/continue.rpy:95
    old "Did you help the women escape from the human milking factory on Barranthis?"
    new "Hai aiutato le donne a fuggire dalla fabbrica di mungitura umana su Barranthis?"

    # game/continue.rpy:95
    old "Did you alter the simulation of Eva and Lilly on the Iron Bastard?"
    new "Hai modificato la simulazione di Eva e Lilly sull'Iron Bastard?"
    ...
    new "Vuoi mettere incinta Lilly?"
    ...
    new "Hai una relazione con Ziv (Futa)?"
